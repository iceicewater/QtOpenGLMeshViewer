...
// Accessors
inline const QVector3D& Transform3D::getTranslation() const { return m_translation; }
inline const QVector3D& Transform3D::getScale() const { return m_scale; }
inline const QQuaternion& Transform3D::getRotation() const { return m_rotation; }
